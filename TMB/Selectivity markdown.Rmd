...
kable1 <- table1 %>%
  ...
  kable_styling(full_width = TRUE, html_font = "Cambria", font_size = 10)
...
Overall, the 3D-AR1 model had the lowest retrospective bias in spawning stock biomass ([Fig. 10](#fig10) & [Fig. 11](#fig11) & [Fig. 12](#fig12)). When evaluating retrospective bias of age-specific selectivity, it is clear that across models 1 and 7, using the projected selectivity outperforms using the average selectivity from the 4 years prior to the terminal year of the assessment (Table 3). However, the result is variable for model 8. However, age-specific retrospective bias varied across selectivity functions. For example, projected selectivity from Model 8 had lower mean squared error for ages 2-3 than projected selectivity from Model 1, but much higher mean squared error for 6+.
...
![Retrospective spawning stock biomass for model 1 (parDevs) with n = 5 peels](Results/Figure10 Model 1 retros.png){#fig10}

![Retrospective spawning stock biomass for model 7 (2D AR1) with n = 5 peels](Results/Figure10 Model 7 retros.png){#fig11}
![Retrospective spawning stock biomass for model 8 (3D AR1) with n = 5 peels](Results/Figure10 Model 8 retros.png){#fig12}
